...
// controller
angular.module('starter.controller', ['ngCordovaOauth', 'ngStorage'])

.controller("LoginController", function($scope, $cordovaOauth, $localStorage, $location, $http){
  $scope.login=function(){

      var callback_path='//localhost'+location.pathname+'#/callback';
...
.controller("CallbackController", function($scope, $cordovaOauth, $localStorage, $location, $http){
